...
function usage() {
    console.error('Usage: GHOST_GOLDEN_POST_AUTH=id:secret bun run generate-golden-email <segment> <output-path>');
    console.error('');
    ...
    console.error('Requires a running Ghost dev instance (bun run dev).');
    process.exit(1);
}
