...
export default Model.extend(ValidationEngine, {
    ...
    ogImage: attr('string'),
    emailProvider: attr('string'),
    mailgunApiKey: attr('string'),
    mailgunDomain: attr('string'),
    mailgunBaseUrl: attr('string'),
    cloudflareEmailAccountId: attr('string'),
    cloudflareEmailZoneId: attr('string'),
    cloudflareEmailApiToken: attr('string'),
    cloudflareEmailSenderDomain: attr('string'),
